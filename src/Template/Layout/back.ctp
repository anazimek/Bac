            ...
            <div class="container-fluid" style="background-color: blueviolet">
                <div class="navbar-header">
                    ...
                    <div style="background-color: yellow">
                        <a style="color: white" class="navbar-brand" href="/admin/">Utilisateurs</a>
                        <a style="color: white" class="navbar-brand" href="/admin/ads/">Annonces</a>
                        <a style="color: white" class="navbar-brand" href="/admin/articles/">Posts</a>
                        <a style="color: white" class="navbar-brand" href="/admin/comments/">Commentaires</a>
                    </div>
                    <a style="color: white;margin-left:300%;margin-top: -15%" class="btn btn-default">Déconnexion</a>
                </div>
